...
def sync_one_organization(organization_code):
    print(f"Συγχρονισμός φορέα {organization_code} από την Απογραφή...")
    ...
    print(f"Τέλος συγχρονισμού φορέα {organization_code} από την Απογραφή.")
